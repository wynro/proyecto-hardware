...
CELDA cuadricula[NUM_FILAS][NUM_COLUMNAS] __attribute__((align(4))) = { {
		...
		0, 0, 0, 0, 0, 0, 0 }, { 0x8800, 0x0000, 0x0000, 0x0000, 0x0000, 0x4800,
		...
		0x0030, 0x0000, 0x7800, 0x0000, 0x3800, 0x2800, 0x0000, 0x4800, 0x0000,
...
CELDA cuadriculaCasiResuelta[NUM_FILAS][NUM_COLUMNAS] __attribute__((align(4)))
= { { 0x0000, 0x6800, 0x4800, 0x3800, 0x2800, 0x1800, 0x7800, 0x5800, 0x8800, 0,
		0, 0, 0, 0, 0, 0 }, { 0x8800, 0x7800, 0x5800, 0x9800, 0x6800, 0x4800,
		0x3800, 0x1800, 0x2800, 0, 0, 0, 0, 0, 0, 0 }, { 0x1800, 0x2800, 0x3800,
		0x5800, 0x8800, 0x7800, 0x9800, 0x6800, 0x4800, 0, 0, 0, 0, 0, 0, 0 }, {
		0x4800, 0x3800, 0x9800, 0x2800, 0x5800, 0x8800, 0x1800, 0x7800, 0x6800,
		0, 0, 0, 0, 0, 0, 0 }, { 0x2800, 0x1800, 0x6800, 0x7800, 0x9800, 0x3800,
		0x4800, 0x8800, 0x5800, 0, 0, 0, 0, 0, 0, 0 }, { 0x7800, 0x5800, 0x8800,
		0x4800, 0x1800, 0x6800, 0x2800, 0x3800, 0x9800, 0, 0, 0, 0, 0, 0, 0 }, {
		0x5800, 0x9800, 0x7800, 0x6800, 0x3800, 0x2800, 0x8800, 0x4800, 0x1800,
		0, 0, 0, 0, 0, 0, 0 }, { 0x3800, 0x8800, 0x2800, 0x1800, 0x4800, 0x5800,
		0x6800, 0x9800, 0x7800, 0, 0, 0, 0, 0, 0, 0 }, { 0x6800, 0x4800, 0x1800,
		0x8800, 0x7800, 0x9800, 0x5800, 0x2800, 0x3800, 0, 0, 0, 0, 0, 0, 0 } };
		...
		case title_screen:
			if (Button_next()) {
				...
				if (Button_valor_actual() == 1) {
					memcpy(cuadriculaSeleccionada, cuadricula, sizeof(cuadriculaSeleccionada));
				} else {
					memcpy(cuadriculaSeleccionada, cuadriculaCasiResuelta, sizeof(cuadriculaSeleccionada));
				}
				// Reseteamos to-do
