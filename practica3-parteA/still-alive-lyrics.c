...
char *still_alive[STILL_ALIVE_SIZE] = {
	...
	"Dario Suarez Gracia",
	"por aguantar mis preguntas raras.",
	"",
	"A mis companeros,",
	"por ayudarme a soportar la ",
	"presion de hacerlo solo.",
	"",
	"A mi familia,",
	"por aguantarme cuando hablaba de",
	"frames maestros y demas.",
	"",
	"Y a ti por jugar",
	"",
	"",
