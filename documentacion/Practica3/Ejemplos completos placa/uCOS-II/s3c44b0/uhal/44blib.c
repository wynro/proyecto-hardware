...
void Port_Init(void)
{
	...
	/*  IISCLK(56)		IISDI(57)	IISDO(58)	IISLRCK(59)	Input		Input		Input		IICSDA		IICSCL	*/
	/*	100		100		100		100		00		00		00		10		10		*/
	/*	*/
	rPCONF = 0x92400;//0x24900a;//New Ver.:0x92400; Old Ver.:0x24900a;
	rPUPF  = 0x1e3;
	rPDATF = 0;
