...
sudoku_candidatos_arm_bucle_fila_columna_si_columna_cero:
	...
	bpl sudoku_candidatos_arm_bucle_fila_columna_region_fila_no_3
	mov r5, #3 // Es negativa, estamos en las region 0 o 1, asumimos 1
sudoku_candidatos_arm_bucle_fila_columna_region_fila_no_3:
	cmp r1, #3 // Si la resta fila - 3 ...
	bpl sudoku_candidatos_arm_bucle_fila_columna_region_fila_no_2
	mov r5, #0 // Es negativa, estamos en la region 0
sudoku_candidatos_arm_bucle_fila_columna_region_fila_no_2:
	...
	mov r5, #6
	cmp r2, #6
	bpl sudoku_candidatos_arm_bucle_fila_columna_region_columna_no_3
	mov r5, #3
sudoku_candidatos_arm_bucle_fila_columna_region_columna_no_3:
	cmp r2, #3
	bpl sudoku_candidatos_arm_bucle_fila_columna_region_columna_no_2
	mov r5, #0
sudoku_candidatos_arm_bucle_fila_columna_region_columna_no_2:
	mov r2, r5
